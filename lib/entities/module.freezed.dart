...
mixin _$Module {
 ...
 String get title; String get icon; String get image; int get order; List<ModulePart> get parts;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Module&&(identical(other.title, title) || other.title == title)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.image, image) || other.image == image)&&(identical(other.order, order) || other.order == order)&&const DeepCollectionEquality().equals(other.parts, parts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,icon,image,order,const DeepCollectionEquality().hash(parts));
...
@useResult
$Res call({
 String title, String icon, String image, int order, List<ModulePart> parts
});
...
/// Create a copy of Module
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? icon = null,Object? image = null,Object? order = null,Object? parts = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String icon,  String image,  int order,  List<ModulePart> parts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Module() when $default != null:
return $default(_that.title,_that.icon,_that.image,_that.order,_that.parts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String icon,  String image,  int order,  List<ModulePart> parts)  $default,) {final _that = this;
switch (_that) {
case _Module():
return $default(_that.title,_that.icon,_that.image,_that.order,_that.parts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String icon,  String image,  int order,  List<ModulePart> parts)?  $default,) {final _that = this;
switch (_that) {
case _Module() when $default != null:
return $default(_that.title,_that.icon,_that.image,_that.order,_that.parts);case _:
  return null;
...
class _Module implements Module {
  const _Module({required this.title, required this.icon, required this.image, required this.order, required final  List<ModulePart> parts}): _parts = parts;
...
@override List<ModulePart> get parts {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Module&&(identical(other.title, title) || other.title == title)&&(identical(other.icon, icon) || other.icon == icon)&&(identical(other.image, image) || other.image == image)&&(identical(other.order, order) || other.order == order)&&const DeepCollectionEquality().equals(other._parts, _parts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,icon,image,order,const DeepCollectionEquality().hash(_parts));
...
/// Create a copy of Module
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? icon = null,Object? image = null,Object? order = null,Object? parts = null,}) {
