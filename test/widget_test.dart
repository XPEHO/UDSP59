    ...
    const Module(
      ...
      parts: [
        ...
        ModulePart(
          ...
          image: "",
          elements: [
            ModulePartElement(text: "18", image: ""),
            ModulePartElement(text: "112", image: ""),
            ModulePartElement(text: "15", image: ""),
          ],
        ),
        ModulePart(
  ...
  group('Homepage tests', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          MaterialApp(
            home: const Scaffold(body: TitleHeader()),
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(body: ModulesCarousel(modules: modulesList)),
          ),
        );
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          ProviderScope(
            child: MaterialApp(
              home: Scaffold(
                body: ModulesCarouselElement(module: modulesList[0]),
              ),
              routes: {'/module': (context) => const ModulePage()},
            ),
          ),
        );
        ...
        if (modulesList[0].icon == "") {
          ...
          var modulesCarouselElementIcon = find.byIcon(
            materialIcons[modulesList[0].icon]!,
          );
          expect(modulesCarouselElementIcon, findsOneWidget);
        }
  ...
  group('About Page tests', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          const MaterialApp(
            home: Scaffold(body: PageHeader(pageTitle: 'aboutTitle')),
          ),
        );
        ...
        var returnButton = find.widgetWithIcon(
          IconButton,
